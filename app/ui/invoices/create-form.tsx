      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="customer-error" aria-live="polite" aria-atomic="true">
            ...
            {state.errors?.customerId && // Check if customerId has errors
        ...
        <div className="mb-4">
          ...
          <div id="customer-error" aria-live="polite" aria-atomic="true">
            {state.errors?.amount && // Check if customerId has errors
        ...
        <div id="customer-error" aria-live="polite" aria-atomic="true">
          {state.errors?.status && // Check if customerId has errors
